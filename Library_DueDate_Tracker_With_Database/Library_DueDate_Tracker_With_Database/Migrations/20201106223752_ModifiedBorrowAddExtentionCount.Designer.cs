...
namespace Library_DueDate_Tracker_With_Database.Migrations
{
    ...
    [Migration("20201106223752_ModifiedBorrowAddExtentionCount")]
    partial class ModifiedBorrowAddExtentionCount
    {
            ...
            modelBuilder.Entity("Library_DueDate_Tracker_With_Database.Models.Borrow", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = -11,
                            BookID = 1,
                            CheckedOutDate = new DateTime(2015, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
